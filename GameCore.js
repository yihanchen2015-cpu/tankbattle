...
function createTank(data, x, y, team, isPlayer, masteryLevelOverride = null) {
    ...
    const tank = {
        ...
        hp: Math.round(data.hp * (masteryVisual ? masteryVisual.hpMult : 1)),
        maxHp: Math.round(data.maxHp * (masteryVisual ? masteryVisual.hpMult : 1)),
        speed: data.speed * (masteryVisual ? masteryVisual.speedMult : 1),
