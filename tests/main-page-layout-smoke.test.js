...
const modeButtons = html.match(/id="btnMode(?:Classic|Ranked|Defense|Sneak|Escort|Deathmatch|Boss|Training|Custom)"/g) || [];
assert.strictEqual(modeButtons.length, 9, 'home page should expose exactly nine playable modes');
