...
assert(html.includes('Achievement.js?v=physics-settings-28') && html.includes('UI.js?v=physics-settings-28') && html.includes('Combat.js?v=physics-settings-28'), 'changed scripts should use fresh cache keys');
