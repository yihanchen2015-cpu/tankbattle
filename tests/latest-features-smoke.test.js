...
assert(html.includes('Achievement.js?v=armory-skins-29') && html.includes('UI.js?v=armory-skins-29') && html.includes('Combat.js?v=armory-skins-29'), 'changed scripts should use fresh cache keys');
